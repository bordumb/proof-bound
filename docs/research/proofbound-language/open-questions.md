...
| OQ-006 | Which effects can be enforced statically, which require an OS sandbox, and which can only be observed afterward? | H5, H9, WS-FX, EXP-LANG-005, EXP-LANG-011, EXP-LANG-012, EXP-LANG-013, EXP-LANG-014, EXP-LANG-015, EXP-LANG-016, EXP-LANG-017, EXP-LANG-018, EXP-LANG-019 | bounded fast macOS and exact-loader Linux tested; Windows exact execution and observed network non-delivery supported, exact denial open; broader system effects open |
...
EXP-LANG-019 executes exactly that repair. Binary output closes the cross-
platform byte defect. Each loopback endpoint is proven reachable by the same
staged subject; no sandboxed connection is accepted; no capability or exemption
is present; and no result is reusable. The preregistered exact-denial question
still fails because Windows returns timeout or reaches the process deadline,
not the required access-denied code. OQ-006 therefore gains a concrete
