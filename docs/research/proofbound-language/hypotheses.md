...
| H4 | testing | A typed assurance DSL can reduce authoring errors and duplication while compiling identically to existing manifests. | Equivalent frontends diverge or the effective programme is harder to review. | EXP-LANG-004 / Experiment 0011 |
