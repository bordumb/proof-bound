...
|---|---|---|---|---|
| [0001](0001-matrix-math-release-verification/README.md) | Matrix Math release verification | local `matrix-math` repo | Pattern A at scale; independent release verification; CAS sealing | planned |
