...
| [0019](0019-batched-enforcement-latency/README.md) | Batched enforcement latency | EXP-0018 Python, Node, and Rust corpus under a concurrent isolated scheduler | Latency repair, per-run isolation, receipt completeness, independent validation | planned |
| [0020](0020-linux-enforcement-portability/README.md) | Linux enforcement portability | EXP-0018 effect contract compiled to a Linux Landlock/seccomp candidate | Semantic policy parity, fail-closed availability, independent policy validation | planned |
